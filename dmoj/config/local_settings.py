...
ALLOWED_HOSTS = ['*', 'localhost', 'qtoj.ddns.net']
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('MYSQL_PASSWORD', '69696969'),
...
EMAIL_HOST_USER = 'quangtrioj@gmail.com'
EMAIL_HOST_PASSWORD = 'xtfl zsan gaox gana'
EMAIL_PORT = 587
...
SERVER_EMAIL = 'QTOJ: Quang Tri Online Judge <awmpubg42@gmail.com>'
...
SITE_LONG_NAME = 'QTOJ: Quang Tri Online Judge'
SITE_ADMIN_EMAIL = 'mondellbit009@tleoj.edu.vn'
...
MEDIA_URL = os.environ.get('MEDIA_URL', 'https://quangtrioj.edu.vn/')
...
EVENT_DAEMON_GET = 'ws://https://quangtrioj.edu.vn/event/'.format(host=HOST)
